...
import com.example.demo.security.filter.EmailCodeAuthenticationFilter;
...
public class securityConfig {
    ...
    @Bean
    AuthenticationProvider authenticationProvider(PasswordEncoder encoder, UserDetailsService userDetailsService)
            throws Exception {
    ...
    @Bean
    AuthenticationManager authenticationManager(AuthenticationProvider... providers){
